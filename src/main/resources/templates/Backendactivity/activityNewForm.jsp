            ...
            <div class="col-md-6 grid-margin stretch-card container">
              <div class="card">
                <div class="card-body">
                  ...
                  <form:form id="form" cssClass="forms-sample" action="saveActivity" method="post" modelAttribute="activity">
...
<%-- 					<form:input type="file" path="ac_image" cssClass="form-control" id="ac_image" name="ac_image"/> --%>
